...
import com.williamyo.service.ApiClient;
import com.williamyo.service.GetService;
...
public class MainActivity extends AppCompatActivity {
     ...
     */
    private void generateDataList(List<User> _userList){
        recyclerView = findViewById(R.id.customRecyclerView);
        adapter = new CustomAdapter(_userList);
